...
void main() {
  testWidgets(
    'AnalyticsScreen renders tabs, time horizon, chart card, and FAB',
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            metricSeriesProvider.overrideWith(
              (ref) async => <HealthDataPoint>[],
            ),
          ],
  ...
  testWidgets(
    'AnalyticsScreen opening modal and logging metric shows checkmark and no SnackBar',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
