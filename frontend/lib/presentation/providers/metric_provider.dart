...
final offlineMetricRepositoryProvider = Provider<OfflineMetricRepository>((ref) {
  final db = ref.watch(databaseProvider);
  final client = ref.watch(apiClientProvider);
  return OfflineMetricRepository(db: db, apiClient: client);
});

final dailyMetricSummaryProvider = FutureProvider.autoDispose<Map<String, double>>((ref) async {
