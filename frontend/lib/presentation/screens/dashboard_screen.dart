      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            const Text('POS', style: TextStyle(fontWeight: FontWeight.w800, letterSpacing: 0.5)),
          ],
        ),
        actions: [
          IconButton(
        ...
        child: ListView(
          ...
          children: [
            ...
            QuadrantCard(
              ...
              isActive: isToday && quadrantState.activeWindow == TimeWindow.morning,
            ...
            QuadrantCard(
              ...
              isActive: isToday && quadrantState.activeWindow == TimeWindow.afternoon,
            ...
            QuadrantCard(
              ...
              isActive: isToday && quadrantState.activeWindow == TimeWindow.evening,
            ...
            QuadrantCard(
              ...
              isActive: isToday && quadrantState.activeWindow == TimeWindow.night,
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          onChanged: (val) => setState(() => category = val ?? 'MEDS'),
                        ),
                      ),
                      ...
                      Expanded(
                        child: DropdownButtonFormField<TimeWindow>(
                          ...
                          onChanged: (val) => setState(() => window = val ?? TimeWindow.morning),
                        ),
                      ),
                    ],
                  ),
